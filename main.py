...
_UART_SERVICE_UUID = bluetooth.UUID(0x181A)
_UART_RX_CHAR_UUID = bluetooth.UUID("6E400002-B5A3-F393-E0A9-E50E24DCCA9F")
_UART_TX_CHAR_UUID = bluetooth.UUID("6E400003-B5A3-F393-E0A9-E50E24DCCA9F")
_ENV_SENSE_UUID = [
    bluetooth.UUID(0x181A),
    bluetooth.UUID(0x181C),
    ]
####################################################################
_UART_UUID = bluetooth.UUID(0x181B)
_UART_TX = (
